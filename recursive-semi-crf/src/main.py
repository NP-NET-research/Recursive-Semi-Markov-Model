...
def make_hparams():
    return nkutil.HParams(
        ...
        # tag_emb_dropout=0.,
        # word_emb_dropout=0.,
        # morpho_emb_dropout=0.,
        # timing_dropout=0.,
        # char_lstm_input_dropout=0.,

        bert_model="../data/bert",
...
def main():
    ...
    subparser.add_argument("--train-path", default="../data/train9.txt")
    subparser.add_argument("--dev-path", default="../data/dev9.txt")
    ...
    subparser.add_argument("--model-path-base", required=True)
    subparser.add_argument("--evalb-dir", default="../EVALB/")
    subparser.add_argument("--test-path", default="../data/test9_sf.txt")
